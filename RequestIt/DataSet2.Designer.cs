...
namespace RequestIt {
    ...
    public partial class DataSet2 : global::System.Data.DataSet {
        ...
        public partial class DataTable1DataTable : global::System.Data.TypedTableBase<DataTable1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public DataTable1Row AddDataTable1Row(string ProductName, int Qtde, decimal TotalPrice) {
        ...
        public partial class DataTable1Row : global::System.Data.DataRow {
            ...
            public int Qtde {
                get {
                    try {
                        return ((int)(this[this.tableDataTable1.QtdeColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Qtde\' in table \'DataTable1\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableDataTable1.QtdeColumn] = value;
                }
            }
            ...
            public bool IsQtdeNull() {
                return this.IsNull(this.tableDataTable1.QtdeColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetQtdeNull() {
                this[this.tableDataTable1.QtdeColumn] = global::System.Convert.DBNull;
            }
...
namespace RequestIt.DataSet2TableAdapters {
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::RequestIt.Properties.Settings.Default.RequestItConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        QueryResult4.name AS ProductName, QueryResult3.TotalQtde AS Qtde, Q" +
                "ueryResult3.TotalQtde * QueryResult4.costPrice AS TotalPrice\r\nFROM            (S" +
                "ELECT        allIds, SUM(tQuantity) AS TotalQtde\r\n                          FROM" +
                "            (SELECT        ISNULL(cp.productId, ri.productId) AS allIds, ri.quan" +
                "tity * ISNULL(cp.quantity, 1) AS tQuantity\r\n                                    " +
                "                FROM            RequestsItems AS ri INNER JOIN\r\n                " +
                "                                                              Requests AS r ON r" +
                ".id = ri.requestId INNER JOIN\r\n                                                 " +
                "                             Products AS p ON p.id = ri.productId LEFT OUTER JOI" +
                "N\r\n                                                                             " +
                " CompoundProducts AS cp ON cp.compoundProductId = ri.productId\r\n                " +
                "                                    WHERE        (r.requestDate BETWEEN CAST(@st" +
                "artDate AS Date) AND CAST(@endDate AS Date))) AS QueryResult1\r\n                 " +
                "         GROUP BY allIds) AS QueryResult3 INNER JOIN\r\n                          " +
                "   (SELECT        id, name, costPrice\r\n                               FROM      " +
                "      Products\r\n                               WHERE        (id IN\r\n            " +
                "                                                 (SELECT DISTINCT allIds\r\n      " +
                "                                                         FROM            (SELECT" +
                "        ISNULL(cp.productId, ri.productId) AS allIds\r\n                          " +
                "                                                               FROM            R" +
                "equestsItems AS ri INNER JOIN\r\n                                                 " +
                "                                                                  Requests AS r " +
                "ON r.id = ri.requestId INNER JOIN\r\n                                             " +
                "                                                                      Products A" +
                "S p ON p.id = ri.productId LEFT OUTER JOIN\r\n                                    " +
                "                                                                               C" +
                "ompoundProducts AS cp ON cp.compoundProductId = ri.productId\r\n                  " +
                "                                                                       WHERE    " +
                "    (r.requestDate BETWEEN CAST(@startDate AS Date) AND CAST(@endDate AS Date)))" +
                " AS QueryResult2\r\n                                                              " +
                " GROUP BY allIds))) AS QueryResult4 ON QueryResult3.allIds = QueryResult4.id";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@startDate", global::System.Data.SqlDbType.DateTime, 3, global::System.Data.ParameterDirection.Input, 0, 0, "requestDate ", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@endDate", global::System.Data.SqlDbType.DateTime, 3, global::System.Data.ParameterDirection.Input, 0, 0, "requestDate ", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(DataSet2.DataTable1DataTable dataTable, System.DateTime startDate, System.DateTime endDate) {
        ...
        public virtual DataSet2.DataTable1DataTable GetData(System.DateTime startDate, System.DateTime endDate) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((System.DateTime)(startDate));
            this.Adapter.SelectCommand.Parameters[1].Value = ((System.DateTime)(endDate));
